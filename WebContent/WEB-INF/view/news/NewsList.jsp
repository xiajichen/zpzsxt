...
<body class="childrenBody">
	...
	<div class=" news_list">
	  	<table class="layui-table">
		    ...
		    <thead>
				<tr>
					<th><input type="checkbox" name="" onclick="chooseAllNews();" lay-skin="primary" lay-filter="allChoose" id="allChoose"></th>
					<th style="text-align:center;">新闻链接</th>
					<th>操作</th>
				</tr> 
		    </thead>
		    <tbody class="newsli" id="soManyNews">
		    </tbody>
		</table>
	</div>
